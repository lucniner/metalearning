...
import at.hwl.machinelearning.ass3.metalearning.featureextraction.extractors.NumMissingValuesFeatureExtractor;
...
public class FeatureExtractorRunner implements Callable<FeaturePairs> {
  ...
  private void initializeFeatureExtractors() {
    ...
    featureExtractors.add(new NumMissingValuesFeatureExtractor(instance));
  }
